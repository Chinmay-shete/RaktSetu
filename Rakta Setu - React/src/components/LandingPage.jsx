      ...
      >
        ...
        >
          ...
          <div className="text-center mb-6 md:mb-8 shrink-0">
            ...
            <p className="text-[14px] md:text-[15px] text-[#5A5A5A]">Select your portal role to register or log in to the system console.</p>
          </div>
              ...
              >
                <div className="flex items-center gap-4 flex-1">
                  ...
                  <div className="space-y-0.5 flex-1 min-w-0">
                    <h4 className="font-serif text-[16px] font-[700] text-[#1A1A1A]">{title}</h4>
                    <p className="text-[13px] text-[#6B6B6B] leading-normal max-w-xl truncate md:whitespace-normal">{desc}</p>
                  </div>
                </div>
