        ...
        <div className="w-full max-w-[540px] bg-white border border-[#EDE7E1] rounded-2xl shadow-[0_4px_24px_rgba(0,0,0,0.08)] p-10 animate-fade-in">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div>
                ...
                {errors.age && touched.age && (
                  <p className="text-[12px] text-[#BE1F2E] mt-1.5">{errors.age}</p>
                )}
              </div>
              ...
              <div>
                ...
                <div className="flex gap-2">
                  {['Male', 'Female', 'Other'].map((g) => (
                    <button
                      ...
                      type="button"
                      onClick={() => setGender(g)}
                      className={`flex-1 py-3 rounded-xl text-[13px] font-[600] border transition-all duration-150 ${
                        gender === g
                          ? 'bg-[#BE1F2E] border-[#BE1F2E] text-white shadow-[0_4px_12px_rgba(190,31,46,0.3)]'
                ...
                {errors.gender && (
                  <p className="text-[12px] text-[#BE1F2E] mt-1.5">{errors.gender}</p>
                )}
              </div>
            </div>
            ...
            <div>
              ...
              <div className="grid grid-cols-4 gap-2.5">
                {bloodGroups.map((bg) => (
                  <button
                    ...
                    className={`aspect-square flex items-center justify-center rounded-xl border text-[16px] font-[700] transition-all duration-150 active:scale-95 ${
                      bloodGroup === bg
                        ? 'bg-[#BE1F2E] border-[#BE1F2E] text-white shadow-[0_4px_12px_rgba(190,31,46,0.3)]'
              ...
              {errors.bloodGroup && (
                <p className="text-[12px] text-[#BE1F2E] mt-2">{errors.bloodGroup}</p>
              )}
            </div>
