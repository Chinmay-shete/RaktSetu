    ...
    <div className="bg-[#F5F0EB] text-[#1A1A1A] overflow-x-hidden min-h-screen" style={{ fontFamily: 'DM Sans, sans-serif' }}>
        ...
        <Container className="flex justify-between items-center h-full">
          ...
          <div className="flex items-center gap-4 shrink-0">
            ...
            <button
              ...
              className="px-3 py-1.5 rounded-full border border-[#E0DAD4] text-[13px] font-[600] text-[#5A5A5A] hover:bg-[#BE1F2E]/10 hover:text-[#BE1F2E] transition-all flex items-center gap-1.5 cursor-pointer whitespace-nowrap"
      ...
      >
        ...
        <Container className="relative z-10 text-center py-20 md:py-28">
          ...
          >
            {language === 'hi' ? (
              t("The smartest way to manage blood in India")
            ) : (
              <>
          ...
          >
            {language === 'hi' ? (
              t("AI-driven logistics layer for India's blood supply chain. Reducing wastage by up to 10% using real-time predictive demand sensing.")
            ) : (
              <>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              ...
              <div key={label} className="relative pt-8 px-6 md:px-10 pb-8 bg-[#fbf9f6] border border-[#E0DAD4] rounded-2xl shadow-sm hover:shadow-md hover:-translate-y-0.5 transition-all duration-200">
                ...
                <p className="text-[14px] font-[600] text-[#1A1A1A] mb-1">{t(label)}</p>
                <p className="text-[13px] text-[#6B6B6B]">{t(desc)}</p>
              </div>
            ))}
          </div>
        </Container>
      ...
      <div className="bg-[#1A0A0A] py-5 overflow-hidden flex border-y border-white/5" style={{ whiteSpace: 'nowrap' }}>
        {[0, 1].map((k) => (
          <div key={k} className="flex animate-marquee gap-16 items-center shrink-0" style={{ paddingRight: 64 }}>
            {['PREDICTIVE ANALYTICS', 'COLD CHAIN MONITORING', 'DONOR RETENTION', 'REAL-TIME INVENTORY', 'INTER-HOSPITAL TRANSFER'].map((tString) => (
              <span key={tString} className="text-white/40 text-[11px] font-[700] tracking-widest flex items-center gap-4">
                {t(tString)}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="bg-[#1A0A0A] rounded-2xl p-10 md:row-span-2 relative overflow-hidden flex flex-col justify-between min-h-[520px]">
              <div className="relative z-10">
                ...
                >
                  {t("Unified Supply Dashboard")}
                </h3>
                <p className="text-white/60 text-[16px] leading-[1.6] max-w-sm">
                  {t("Every unit tracked, from collection to transfusion. Zero blind spots in the national grid.")}
                </p>
              </div>
              ...
              <div className="mt-10 bg-white border border-[#E0DAD4] rounded-xl p-6 text-[#1A1A1A]">
                <div className="flex justify-between items-center mb-5">
                  <span className="text-[#1A1A1A] text-[14px] font-[600]">{t("Real-time Stock (Pune Cluster)")}</span>
            ...
            {[
              ...
              >
                ...
                <p className="text-[15px] text-[#5A5A5A] leading-[1.6] text-left">{t(desc)}</p>
              </div>
            ))}
          </div>
        </Container>
      ...
      <section className="py-24 bg-white border-y border-[#E0DAD4]" id="process">
        <Container>
          <h2
            className="font-serif text-center mb-20 text-[#1A0A0A]"
            style={{ fontSize: 'clamp(28px, 4vw, 48px)', fontWeight: 700, fontFeatureSettings: '"liga" 0' }}
          >
            {language === 'hi' ? (
              t("The Lifecycle of a Life")
            ) : (
              <>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6 relative">
            ...
            {[
              ...
              <div key={title} className="relative z-10 text-left bg-white border border-[#EDE7E1] rounded-2xl p-6 shadow-sm hover:-translate-y-1 hover:shadow-md transition-all duration-200 min-w-[220px]">
                ...
                <h5 className="font-[700] text-[17px] text-[#1A1A1A] mb-3">{t(title)}</h5>
                <p className="text-[15px] text-[#5A5A5A] leading-[1.6] text-left">{t(desc)}</p>
              </div>
            ))}
          </div>
      ...
      <section className="py-24" id="who">
        <Container>
          <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-8">
            <div>
              <h2
                className="font-serif mb-4 text-[#1A0A0A]"
                style={{ fontSize: 'clamp(28px, 4vw, 48px)', fontWeight: 700, fontFeatureSettings: '"liga" 0' }}
              >
                {language === 'hi' ? (
                  t("Built for the entire ecosystem")
                ) : (
                  <>
              ...
              <p className="text-[17px] text-[#5A5A5A] leading-[1.6]">
                {t("A modular platform that scales across organizational roles and requirements.")}
              </p>
            </div>
            ...
            {[
              ...
              >
                <div>
                  ...
                  <h6 className="font-[700] text-[17px] text-[#1A1A1A] mb-2">{t(title)}</h6>
                  <p className="text-[15px] text-[#5A5A5A] leading-[1.6] mb-6 text-left">{t(desc)}</p>
                </div>
      ...
      <section className="py-24 bg-white border-y border-[#E0DAD4]" id="pilot">
        <Container>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-start">
            ...
            <div>
              <h2
                className="font-serif mb-8 leading-tight text-[#1A0A0A]"
                style={{ fontSize: 'clamp(28px, 4vw, 48px)', fontWeight: 700, fontFeatureSettings: '"liga" 0' }}
              >
                {language === 'hi' ? (
                  t("Ready to modernize your blood logistics?")
                ) : (
                  <>
                    Ready to modernize your <span className="italic text-[#BE1F2E]">blood logistics?</span>
                  </>
                )}
              </h2>
              <ul className="space-y-5 mb-10">
                {[
                  ...
                  <li key={item} className="flex items-start gap-4">
                    ...
                    <p className="text-[16px] font-[500] text-[#1A1A1A] leading-[1.5]">{t(item)}</p>
                  </li>
                ))}
              </ul>
              <div className="flex items-center gap-8">
                <div>
                  ...
                  <div className="text-[14px] font-[500] text-[#5A5A5A] mt-0.5">{t("Active Pilots")}</div>
                </div>
                <div className="w-px h-10 bg-[#E0DAD4]" />
                <div>
                  <div className="text-[28px] font-[700] text-[#1A1A1A]">120k+</div>
                  <div className="text-[14px] font-[500] text-[#5A5A5A] mt-0.5">{t("Units Tracked")}</div>
                </div>
              </div>
              <div className="flex flex-wrap gap-3 mt-8">
                {['Maharashtra Pilot', 'NABH Compliant', 'AI-Enabled'].map((b) => (
                  <span key={b} className="badge-success text-xs font-semibold px-3 py-1.5 flex items-center gap-1.5 border border-[#22A06B]/20">
                    <span className="text-[#22A06B] font-bold">✓</span> {t(b)}
                  </span>
                ))}
              </div>
            </div>
            ...
            <div className="relative">
              ...
              <div className="relative bg-white border border-[#EDE7E1] rounded-2xl p-10 shadow-2xl">
                ...
                <p className="text-[#5A5A5A] text-[15px] leading-[1.6] mb-8">
                  {t("See how RaktSetu can optimize your district's blood supply through real-time predictive data.")}
                </p>
                {formSubmitted ? (
                  <div className="bg-[rgba(34,160,107,0.08)] border border-[rgba(34,160,107,0.2)] rounded-xl p-6 text-center animate-fade-in text-[#22A06B]">
                    ...
                    <p className="font-[700] text-[15px]">{t("Request received!")}</p>
                    <p className="text-[#5A5A5A] text-[13px] mt-1">{t("We'll be in touch within 24 hours.")}</p>
                  </div>
                ) : (
      ...
      <footer className="bg-[#1A0A0A] py-20 border-t border-white/10">
        <Container>
          <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
            <div className="md:col-span-2">
              ...
              <p className="text-[#B0A8A0] text-[15px] leading-[1.7] max-w-sm mb-6">
                {t("Precision blood logistics for India's 1.4 billion people. Building the digital infrastructure for a healthier tomorrow.")}
              </p>
              <span className="text-[#B0A8A0] text-[13px] flex items-center gap-2">
                {t("Made with pride in India")}
                <span
            ...
            {[
              ...
              <div key={title}>
                <h6 className="text-white text-[11px] font-[600] uppercase tracking-widest mb-6">{t(title)}</h6>
                <ul className="space-y-3">
                  {links.map((l) => (
                    <li key={l}>
                      {l === 'Privacy Policy' ? (
                        <Link className="text-[#A09890] hover:text-white transition-colors text-[14px]" to="/privacy">{t(l)}</Link>
                      ) : l === 'Terms of Service' ? (
                        <Link className="text-[#A09890] hover:text-white transition-colors text-[14px]" to="/terms">{t(l)}</Link>
                      ) : (
                        <a className="text-[#A09890] hover:text-white transition-colors text-[14px]" href="#">{t(l)}</a>
                      )}
                    </li>
                  ))}
                </ul>
          ...
          <div className="pt-8 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-4 text-[#A09890] text-[13px]">
            <span>© 2024 RaktSetu AI. {t("Precision Blood Logistics.")}</span>
      ...
      <div
        className={`fixed inset-0 z-[100] flex items-center justify-center p-4 bg-[#1A0A0A]/55 backdrop-blur-md transition-opacity duration-300 ${
          isModalOpen ? 'opacity-100' : 'opacity-0 pointer-events-none'
        }`}
      >
        <div
          className={`bg-white rounded-2xl w-full max-w-3xl p-6 md:p-8 lg:p-10 relative shadow-2xl transition-all duration-300 max-h-[90vh] flex flex-col ${
            isModalOpen ? 'scale-100 opacity-100' : 'scale-95 opacity-0'
          }`}
        >
          {/* Close button */}
          <button
            className="absolute top-4 right-4 md:top-6 md:right-6 w-10 h-10 rounded-full border border-[#E0DAD4] flex items-center justify-center text-[#5A5A5A] hover:bg-[#F5F0EB] hover:text-[#BE1F2E] transition-colors focus-visible:outline-2 focus-visible:outline-[#BE1F2E] z-10"
          ...
          <div className="text-center mb-6 md:mb-8 shrink-0">
            <h2
              className="font-serif text-[28px] md:text-[34px] font-[700] text-[#1A1A1A] mb-2 leading-tight"
              style={{ fontFeatureSettings: '"liga" 0' }}
            >
              {language === 'hi' ? (
                t("Access RaktSetu Portals")
              ) : (
                <>
                  Access <span className="text-[#BE1F2E] italic">RaktSetu</span> Portals
                </>
              )}
            </h2>
            <p className="text-[14px] md:text-[15px] text-[#5A5A5A]">{t("Select your portal role to register or log in to the system console.")}</p>
          </div>
            ...
            {[
              {
                ...
                desc: 'Donate blood, check eligibility, and track your saving impact.',
                actions: [
                  {
                    label: 'Register',
                    primary: true,
              ...
              },
              {
                ...
                icon: 'local_hospital',
                desc: 'Register your clinical facility and manage portal operations.',
                actions: [
                  {
              ...
              },
              {
                ...
                icon: 'group',
                desc: 'Update stock volumes, manage alerts, and handle transfers.',
                actions: [
                  {
                    label: 'Staff Login',
                    primary: true,
              ...
              },
              {
                ...
                desc: 'Organize regional donation camps and inspect shortage analytics.',
                actions: [
                  {
                    label: 'Officer Login',
                    primary: true,
                  ...
                  {
                    label: 'Gov. Authorized',
                    disabled: true,
                    desc: 'Authorized Access'
                  }
                ]
              },
              {
              ...
              },
              {
                ...
                title: 'System Admin',
                icon: 'settings',
                desc: 'Manage system configurations, users, and hospital approvals.',
                actions: [
                  {
                    label: 'Console Login',
                    primary: true,
                  ...
                  },
                  {
                    ...
                    disabled: true,
                    desc: 'Admin Controlled'
                  }
                ]
              }
            ].map(({ id, title, icon, desc, actions }) => (
              <div
                key={title}
                className="p-4 bg-white border border-[#EDE7E1] rounded-xl flex flex-col md:flex-row md:items-center justify-between gap-4 hover:shadow-sm hover:border-[#BE1F2E]/30 transition-all duration-300 group"
              >
                <div className="flex items-center gap-4 flex-1">
                  <div className="w-10 h-10 rounded-xl bg-[rgba(190,31,46,0.06)] flex items-center justify-center shrink-0 text-[#BE1F2E] transition-transform duration-300 group-hover:scale-105">
                    <span className="material-symbols-outlined text-[22px]">{icon}</span>
                  </div>
                  <div className="space-y-0.5 flex-1 min-w-0">
                    <h4 className="font-serif text-[16px] font-[700] text-[#1A1A1A]">{t(title)}</h4>
                    <p className="text-[13px] text-[#6B6B6B] leading-normal max-w-xl truncate md:whitespace-normal">{t(desc)}</p>
                  </div>
                </div>
                  ...
                  {actions.map((act, index) => {
                    if (act.disabled) {
                      return (
                        <span
                          key={index}
                          className="px-4 py-2 bg-[#F5F0EB] text-[#8A8078] text-[11px] font-[700] uppercase tracking-wider rounded-full border border-[#EDE7E1]"
                        >
                          {t(act.desc)}
                        </span>
                      );
                    ...
                    if (act.primary) {
                      return (
                        <button
                          ...
                          type="button"
                          onClick={act.onClick}
                          className="px-5 py-2 rounded-full text-[13px] font-[600] text-white shadow-sm transition-all duration-200 bg-[#BE1F2E] hover:bg-[#9E1825] transform hover:scale-[1.03] active:scale-[0.97]"
                        >
                          {t(act.label)}
                        </button>
                      );
                    ...
                    return (
                      <button
                        ...
                        type="button"
                        onClick={act.onClick}
                        className="px-5 py-2 rounded-full text-[13px] font-[600] border bg-white shadow-sm transition-all duration-200 border-[#BE1F2E] text-[#BE1F2E] hover:bg-[rgba(190,31,46,0.04)] transform hover:scale-[1.03] active:scale-[0.97]"
                      >
                        {t(act.label)}
                      </button>
                    );
